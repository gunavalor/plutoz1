...
<table cellpadding="0" cellspacing="0" width="100%" bgcolor="#FFFFFF" border="0">
				...
				<tr>
					...
					<td class="searchboxadj">
						 <table cellpadding="0" cellspacing="0" style="width:536px; height:59px;">
							<tr>
								<td><img src="resources/images/imagesbeta/searchbox_left.gif"/></td>
	...
	<tr>
		<td>
			<table cellpadding="0" cellspacing="0" width="1007">  <!-- Main Table -->  
				<tr valign="top">
					<td width="199px">
												...
												<table border="0" cellpadding="0" cellspacing="0" width="178" background="resources/images/imagesbeta/title_image_middle.jpg">
													...
													<tr>
														...
														<td>
															...
															if($row['img_name'] !=""){
															?>
																<img src="contribute_images/<?php echo $row['img_name']; ?>" width="170px" height="200px" style="border: 2px solid #000000;">
															<?php
															}
															else {
																echo "&nbsp;";
															...
															?>
															<span style="color:#D00800; vertical-align:text-top; font-size:15px;"><b>Hot <?php echo $allwordsdisp; ?>... Hot Deals!</b></span>
															<?php
															  ...
															  echo "<ul>";
															  echo "<li><b><a href=\"category_popup.php?cid=$advid\" rel=\"facebox[.thickstyle]\">$advtitle</a></b></li>";
															  echo "</ul>";
															  }
															?>
														</td>
		...
		<td width="763px">
		<table cellpadding="0" cellspacing="0" border="0" width="763px">
			<tr>
				<td width="534px" height="12px"><img src="resources/images/imagesbeta/left_top_img.png" width="534px" height="12px"></td>
				<td width="229px" height="12px"><img src="resources/images/imagesbeta/right_top.png" width="229px" height="12px"></td>
			</tr>
			<tr style="background-image:url(resources/images/imagesbeta/body_center_bg.jpg); background-repeat:repeat-y;"  width="763px" valign='top'>
				<td width="534px">
				<table cellpadding="0" cellspacing="0" border="0" width="534px"> <!-- Left Table -->
					<tr><td><img src="resources/images/imagesbeta/spacer.gif"  width="1" height="10"></td></tr>
					...
					<tr>
						...
						<table cellpadding="0" cellspacing="0" border="0" align="center" width="505px">
						<tr valign="top"><!-- Hold for Search Results -->
							<td>
<?php ##################################################################################################### ?>
							  <div class="contentColumn1" align="left" >  <!-- contentColumn -->  
                     ...
                     <div align="left" style="padding-left:15px; ">
						...
						<div class="ratingsection">
						    <table cellpadding="0" cellspacing="0" width="200">
							  <tr>
							    <td align="left" class="plutozrating" height="20">Plutoz Rating:</td><td align="left">
								<?php if ($qnum_reviewfound > 0) { ?>
